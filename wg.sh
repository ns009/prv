...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard sudah diinstal, silahkan ENTER addwg untuk menambah client."
	exit 1
fi

echo -e "${Info} Wireguard VPS AutoScript by NS-SSH"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/ns009/prv/main/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/ns009/prv/main/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/ns009/prv/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/ns009/prv/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/ns009/prv/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg

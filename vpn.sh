...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/ns009/prv/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://raw.githubusercontent.com/ns009/prv/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
